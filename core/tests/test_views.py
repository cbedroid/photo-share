...
class TestView(TestCase):
    ...
    def setUp(self):
        ...
        self.detail_url = reverse(
            "core:gallery-detail", kwargs={"slug": "test_gallery_1"}
        )
        self.update_url = reverse(
            "core:gallery-update", kwargs={"slug": "test_gallery_1"}
        )
        self.delete_url = reverse(
            "core:gallery-delete", kwargs={"slug": "test_gallery_1"}
        )
    ...
    def test_gallery_updateview_allows_author_to_update_gallery(self):
    ...
    def test_gallery_update_fails_when_user_is_not_the_author(self):
        # Test updateview return 403 when a gallery is updated by non-creator
        # Test gallery update by non-creator
        client = Client()
        not_the_author = self.create_user(
            username="not_the_author",
            email="not_the_author@tests.com",
            password="test_password",
        )
        client.login(username="not_the_author", password="test_password")
        response = client.get(self.update_url)
    ...
    def test_gallery_updateview_creates_new_image_successfully(self):
        ...
        update_url = reverse("core:gallery-update", kwargs={"slug": test_gallery.slug})
    ...
    def test_gallery_deleteview_throws_403_permission_denied_when_access_by_non_author(
        self,
    ):
        client = Client()
        not_the_author = self.create_user(
            username="not_the_author_2",
            email="not_the_author_2@tests.com",
            password="test_password",
        )
        client.login(username=not_the_author.username, password="test_password")
    ...
    def test_gallery_deleteview_allows_author_to_view_page(self):
        client = Client()
        client.login(username=self.user_1["username"], password="test_password")
        # GET Method
        # Test author can view DeleteView
