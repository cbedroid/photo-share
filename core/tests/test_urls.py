...
class TestUrls(SimpleTestCase):
    ...
    def test_album_create_url_is_resolved(self):
        ...
        self.assertEquals(
            resolve(url).func.view_class,AlbumCreateView
            )
    ...
    def test_album_update_url_is_resolved(self):
        ...
        self.assertEquals(
            resolve(url).func.view_class,AlbumUpdateView
            )
    ...
    def test_album_delete_url_is_resolved(self):
        ...
        self.assertEquals(
            resolve(url).func.view_class,AlbumDeleteView
            )
