...
from rest_framework.mixins import ListModelMixin as ListMM
from rest_framework.mixins import RetrieveModelMixin as RetrieveMM
from rest_framework.mixins import UpdateModelMixin as UpdateMM
